...
class SettingCompanyChangePlan extends React.Component{
    constructor(props) {
        super(props);
        this.state={
            loading: false,
    ...
    async save(){
        ...
        const result = await axios.get('http://localhost:8082/v1/1/updateactualplan', {
            params: {
                API: "ABC",
            ...
            <div className="card shadow col-11 mt-3 m-auto mb-3">
                ...
                <div className="card-body overflow-auto">
                    <table className="table">
                        <thead>
                            <tr>
                                <th>Plan na jaki chcesz zmienić</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
...
export default SettingCompanyChangePlan